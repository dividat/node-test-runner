...
var bundledReadElmiPath = path.join(__dirname, "..", "bin", "elm-interface-to-json") +
  binaryExtension;
...
function findTests(
  ...
  verbose /*: boolean*/,
  customReadElmiPath /*: string */
)/*:Promise<void>*/ {
  var readElmiPath = customReadElmiPath != null ? customReadElmiPath : bundledReadElmiPath;
